...
insert into
	...
	CHATROOM (USER_user_id , TUTOR_USER_user_id, CLASS_class_id) 
...
from MESSAGE m left outer join USER u on m.message_sender = u.user_id 
...
<select id = "getAllCount" resultType = "int">
	...
	select count(*)from MESSAGE WHERE(TUTOR_USER_user_id=# {
		TUTOR_USER_user_id}
	and message_readTime=message_sendTime 
			and message_sender!=#{USER_user_id})
