...
//	c_nreadc
	...
	public TalkChat(String c_no, String c_from_uno, String c_to_uno, String c_mission, String c_readc,
			String c_nreadc) {
		super();
		this.c_no = c_no;
	...
	public String toString() {
		return "TalkChat [c_no=" + c_no + ", c_from_uno=" + c_from_uno + ", c_to_uno=" + c_to_uno + ", c_mission="
